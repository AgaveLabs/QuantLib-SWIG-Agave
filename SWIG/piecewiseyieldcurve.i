...
export_piecewise_curve_new(PiecewiseMixedFlatCubicForward, ForwardRate, MixedForwardFlatCubic);
export_piecewise_curve_new(PiecewiseMixedFlatCubicZero, ZeroYield, MixedForwardFlatCubic);
export_piecewise_curve_new(PiecewiseMixedFlatCubicDiscount, Discount, MixedForwardFlatCubic);

export_piecewise_curve_new(PiecewiseMixedFlatConvexMonotoneForward, ForwardRate, MixedForwardFlatConvexMonotone);
